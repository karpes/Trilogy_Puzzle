...
import karpes_dev.trilogy_pazzle.models.Vector2D;
...
public class MyScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
         boolean onScale(View view, MyScaleGestureDetector detector);
         boolean onScaleBegin(View view, MyScaleGestureDetector detector);
         void onScaleEnd(View view, MyScaleGestureDetector detector);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, MyScaleGestureDetector detector) {
            // Intentionally empty
        }
    }
    ...
    public MyScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
